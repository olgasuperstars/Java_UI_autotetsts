...
public class CreateProject
{
    ...
    public static void main(String[] args ) throws InterruptedException {
        ...
        new Select(webDriver.findElement(By.xpath("//label[text()='Приоритет']/../following-sibling::div//select"))).selectByVisibleText("Средний");
        ...
        new Select(webDriver.findElement(By.xpath("//label[text()='Менеджер']/../following-sibling::div//select"))).selectByVisibleText("Палкина Анна");
